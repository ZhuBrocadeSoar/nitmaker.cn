...
if($_SESSION['logInState'] != "logIned"){
    ...
    if($_SESSION['submitCount'] >= 1){
        ...
        $result = mysql_query("SELECT id,nickName,passwd FROM userInfo WHERE nickName = \"$tmp\"", $_SESSION['conOfMysql']);
...
<head>
<?php
if($_SESSION['logInInfoState'] == "allMached" || $_SESSION['logInState'] == "logIned"){
    //2秒转跳到用户中心
...
<p>在此页面登录或<a herf = "http://123.206.204.23/nitmaker.cn/signup.php">注册</a><p>
<?php
